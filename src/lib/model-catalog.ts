...
export const MODEL_GROUPS: ProviderGroup[] = [
  ...
  },
  {
    ...
    bg: "bg-[#4285F4]/10",
    models: [
      { value: "gemini-3-5-flash", label: "Gemini 2.5 Flash", apiModel: "gemini-2.5-flash" },
      { value: "gemini-3-1-pro", label: "Gemini 2.5 Pro", apiModel: "gemini-2.5-pro" },
      { value: "gemini-3-flash", label: "Gemini 2.0 Flash", apiModel: "gemini-2.0-flash" },
      { value: "gemini-3-1-flash-lite", label: "Gemini 1.5 Flash", apiModel: "gemini-1.5-flash" },
    ],
  },
  {
    id: "openai",
